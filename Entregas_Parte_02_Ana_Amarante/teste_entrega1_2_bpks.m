%Simulation of BPSK OFDM system in an AWGN environment Follows IEEE 802.11 specification
clear; clc;
%--------Simulation parameters----------------
nSym=1000; %Number of OFDM Symbols to transmit (n_bits = 1000 --> Número de bits) 
EbN0dB = 0:1:14; % bit to noise ratio
%---------------------------------------------
...
Tsignal = 500; %Tgi+Tfft; %duration of BPSK-OFDM symbol (T = 500 --> Tempo de símbolo OFDM)
...
plot(EbN0dB,log10(simulatedBER),'g-o');
hold on;
